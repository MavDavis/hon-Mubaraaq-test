        ...
        <div class="w-full">
          <form class="px-5 pt-6 pb-8 mb-4">
            <p
              ...
              class="error text-center mb-2 text-red-300 text-sm tracking-wide font-semibold"
            >
              {{ $store.state.errMssg }}
            </p>
            <div class="mb-4 relative">
              ...
              <input
                class="appearance-none border rounded w-full py-2 px-8 text-dark leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div class="mb-4 relative">
              <i
                class="fas fa-envelope absolute top-3 left-3 text-dark z-10"
              ></i>
              <input
            ...
            <div class="mb-4 relative">
              ...
              <input
                class="appearance-none bg-gray-100 rounded w-full py-2 px-8 text-dark mb-3 leading-tight focus:outline-none focus:shadow-outline"
